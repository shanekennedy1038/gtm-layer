          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <div
                ...
                style={{
                  background: "rgba(1, 156, 226, 0.04)",
                  borderColor: "rgba(1, 156, 226, 0.2)",
                }}
              >
                <p
                  className="text-sm leading-relaxed"
                ...
                >
                  ...
                  That&apos;s fine — describe your situation in the message field
                  and we&apos;ll respond with a written outline of how GTM Layer
                  could apply to your business. No deck, no pitch — just a
                  straight answer.
                </p>
              </div>
            </div>
